...
import Ccshop from '@material-ui/icons/Store' //商铺
import Ceshop from '@material-ui/icons/Store' //商铺
...
import  Gcshop from '@material-ui/icons/Book'
import  Geshop from '@material-ui/icons/Book'
...
const items = [
  ...
  },
  {
    ...
    icon:<Geshop/>,
      nested: [
        { name: 'eshop', icon: <Ceshop /> },
        { name: 'eproduct', icon: <Cproduct /> },
        { name: 'ecategory', icon: <Ccategory /> },
  ...
  },
  {
    ...
    icon:<Gcshop/>,
      nested: [
        { name: 'cshop', icon: <Ccshop /> },
        { name: 'order', icon: <Corder /> },
        { name: 'cwithdrawcash', icon: <Cwithdraw /> },
        { name: 'cproduct', icon: <Cproduct /> },
        { name: 'recommendhistory', icon: <Ccshop /> },
      ]
  },
  {
        name: 'user',
