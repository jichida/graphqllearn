...
import AvatarUpload from '../../component/PicturesWall/MobileImageUpload/AvatarUpload'
...
const Index = ({history, match, intl: { formatMessage }, values, setFieldValue, isSubmitting, handleSubmit, setSubmitting }) => {
    ...
    const [ saveProfile, { data }] = useMutation(UPDATE_USER)
